...
if(isset($_POST['submit']) && $_POST['submit'] == 'Сохранить') {
        ...
        cash_in_add($connect, $state_id,  $cash_sum, $cash_type, $cash_comment, $cash_date);
...
<div class="page_name">
    <div class="container-fluid">
        ...
        <span class="right_cus">Добавить Приход в кассу (ПКО)</span>
    </div>    
</div>
    ...
    <div class="container-fluid">
        <form action="" method="POST" class="horizntal-form" id="input_form">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <textarea name="cash_comment" type="text" class="form-control" value="" rows="1" placeholder="">Приход в кассу</textarea>
                </div>
            </div>
        </form>
    </div>
