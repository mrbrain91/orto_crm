...
// for count
$count_query = "SELECT count(id) as allcount FROM users_tbl ORDER BY id DESC";
...
if (isset($_POST['id_user'])) {
    ...
    $display_sts_filer_on = 'true';
     ...
     $query = "SELECT * FROM users_tbl WHERE id = '$id_cont' ORDER BY id DESC";
 
     $all_debt_query = "SELECT count(id) as allcount FROM users_tbl WHERE id = '$id_cont' ORDER BY id DESC";
 }
 else 
{
    //list all
    $query = "SELECT * FROM users_tbl ORDER BY id desc LIMIT 0,".$limit;
    $all_debt_query = "SELECT count(id) as allcount FROM users_tbl";
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="#" method="POST" class="horizntal-form" id="filer_form">
            ...
            <div class="row">
                <div class="col-md-12"> 
                    <select required class="normalize" name="id_user" form="filer_form">
