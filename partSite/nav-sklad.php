<nav class="navbar navbar-inverse navbar-custom">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="main-sklad.php">ORTOSAVDO</a>
    </div>
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          <li><a href="order-sklad.php">Заказ</a></li>
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          ...
          <li><a href="in_store-sklad.php">Приход на склад</a></li>
          <!-- <li><a href="#">Возврат поставщику</a></li> -->
          <li><a href="rest-sklad.php">Остатки</a></li>
        </ul>
      </li>
      <!-- <li class="dropdown">
