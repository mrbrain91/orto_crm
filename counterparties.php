...
// for count
$count_query = "SELECT count(id) as allcount FROM counterparties_tbl ORDER BY id DESC";
...
<div class="page_name">
    <div class="container-fluid">
        ...
        <span class="right_cus">Контрагенты</span>
    </div>    
</div>
...
<div class="toolbar">
        <div class="container-fluid">
            <div class="toolbar_wrapper">
                <div>
                    <a href="add_counterpartie.php"> <button type="button" class="btn btn-success">Добавить</button> </a>
                </div>
...
$(document).ready(function () {
    $(document).on('click', '#loadBtn', function () {
      ...
      $.ajax({
        ...
        data: 'rowcounterpartie=' + row +  '&i=' + <?php echo $i;?>,
