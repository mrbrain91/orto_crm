...
// for count
$count_query = "SELECT count(id) as allcount FROM supplier_tbl ORDER BY id DESC";
...
if (isset($_POST['id_supplier'])) {
    ...
    $display_sts_filer_on = 'true';
     ...
     $query = "SELECT * FROM supplier_tbl WHERE id = '$id_cont' ORDER BY id DESC";
 
     $all_debt_query = "SELECT count(id) as allcount FROM supplier_tbl WHERE id = '$id_cont' ORDER BY id DESC";
 }
 else 
{
    //list all
    $query = "SELECT * FROM supplier_tbl ORDER BY id desc LIMIT 0,".$limit;
    $all_debt_query = "SELECT count(id) as allcount FROM supplier_tbl";
...
<div class="page_name">
    <div class="container-fluid">
        ...
        <span class="right_cus">Доставщики</span>
    </div>    
</div>
...
<div class="toolbar">
        <div class="container-fluid">
            <div class="toolbar_wrapper">
                <div>
                    <a href="add_supplier.php"> <button type="button" class="btn btn-success">Добавить</button> </a>
                </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="#" method="POST" class="horizntal-form" id="filer_form">
            ...
            <div class="row">
                <div class="col-md-12"> 
                    <select required class="normalize" name="id_supplier" form="filer_form">
                        <option value="">выберите</option>
                        <?php    
                            while ($option = mysqli_fetch_array($supplier_tbl)) {    
                        ?>
...
$(document).ready(function () {
    $(document).on('click', '#loadBtn', function () {
      ...
      $.ajax({
        ...
        data: 'rowsupplier=' + row +  '&i=' + <?php echo $i;?>,
