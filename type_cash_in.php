...
//---get cashin
$sql = "SELECT * FROM state_in";
$tci_tbl = mysqli_query ($connect, $sql);




// for count
$count_query = "SELECT count(id) as allcount FROM state_in ORDER BY id DESC";
...
// filter form 
if (isset($_POST['id_tci'])) {
    $id_cont = $_POST['id_tci'];
    ...
    $display_sts_filer_on = 'true';
     ...
     $query = "SELECT * FROM state_in WHERE id = '$id_cont' ORDER BY id DESC";
 
     $all_debt_query = "SELECT count(id) as allcount FROM state_in WHERE id = '$id_cont' ORDER BY id DESC";
 }
 else 
{
    //list all
    $query = "SELECT * FROM state_in ORDER BY id desc LIMIT 0,".$limit;
    $all_debt_query = "SELECT count(id) as allcount FROM state_in";
...
<div class="page_name">
    <div class="container-fluid">
        ...
        <span class="right_cus">Статья доходов</span>
    </div>    
</div>
...
<div class="toolbar">
        <div class="container-fluid">
            <div class="toolbar_wrapper">
                <div>
                <a href="add_type_cash_in.php"> <button type="button" class="btn btn-success">Добавить</button> </a>
                </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="#" method="POST" class="horizntal-form" id="filer_form">
            ...
            <div class="row">
                <div class="col-md-12"> 
                    <select required class="normalize" name="id_tci" form="filer_form">
                        <option value="">выберите</option>
                        <?php    
                            while ($option = mysqli_fetch_array($tci_tbl)) {    
                        ?>
