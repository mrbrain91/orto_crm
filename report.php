...
<ul class="nav nav-tabs">
  ...
  <li class="nav-item">
    <a style="color: #666666;" class="nav-link" href="#">отчет о получении товара</a>
  </li>
</ul>
<!-- End tab item -->
...
<div class="all_table" style='display: <?php echo $display;?>' >
    ...
    <center>за период: <b><?php echo $date = date("d.m.Y", strtotime($from_date)); ?> - <?php echo $date = date("d.m.Y", strtotime($to_date)); ?></center> 
